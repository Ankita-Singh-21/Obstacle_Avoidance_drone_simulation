...
class Controller:
    ...
    def callback_1(self,data):
        ...
        pub = rospy.Publisher('/new_topic',Float32,queue_size=1)
        ...
        for i in range(80, 540 )  :
            for j in range(0,350) :
                if (current_frame[j][i] < min_value ):
                    min_value = current_frame[j][i]
...
def main():
    ...
    pub = rospy.Subscriber('/new_topic', Float32,  cnt.callback_2)
